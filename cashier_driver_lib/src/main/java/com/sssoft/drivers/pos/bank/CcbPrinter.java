...
import com.sssoft.drivers.pos.bank.ccb.impl.CcbPrinterImpl;
 ...
 */
public class CcbPrinter extends Printer.Stub{
	private CcbPrinterImpl printerImpl;

	public CcbPrinter(){
		printerImpl = new CcbPrinterImpl(); 
	}
