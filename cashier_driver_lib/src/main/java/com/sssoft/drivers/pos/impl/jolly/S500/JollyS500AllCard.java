 ...
 */
public class JollyS500AllCard extends AllCard.Stub{
	private JollyS500AllCardSample allCardSample;
	
	public JollyS500AllCard(){
		allCardSample =  new JollyS500AllCardSample(AIDLService.ddi);
	}
